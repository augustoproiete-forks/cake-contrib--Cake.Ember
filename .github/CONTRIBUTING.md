# How to contribute
Contributions to Cake.Ember are highly encouraged and desired. Below are some guidelines that will help make the process as smooth as possible.
...
We want to know what you think is missing from Cake.Ember and how it can be made better.
...
* To quickly create a topic branch based on develop; `git checkout -b my_contribution develop`. Please avoid working directly on the `developer` or `master` branch.
